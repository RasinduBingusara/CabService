...
<div class="content">
  ...
  <form action="driver_vehicle" method="post" class="vehicle-form">

    <input type="hidden" name="action" value='<%= request.getAttribute("action")!= null? request.getAttribute("action"): ""%>'>
    <input type="hidden" name="id" value='<%= request.getAttribute("vehicle_id")!= null? request.getAttribute("vehicle_id"): ""%>'>
